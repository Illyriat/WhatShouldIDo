...
// US English) is just another locale file + an entry here, plus a FEATURE_FLAGS.
// languageSupport entry in featureFlags.ts - no other plumbing changes. Every language's
// translation content ships in the bundle regardless of its flag; languageSupport only
// controls what's offered below.
