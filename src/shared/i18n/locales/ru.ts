...
const ruTranslation = {
  ...
  settings: {
    ...
    addonsTitle: 'Аддоны',
    addonsBody:
      'Это приложение считывает данные, которые аддоны ESO записывают на диск. Data Collector входит в состав этого приложения - установите его ниже. Любой другой аддон нужно скачивать отдельно с <esoui>ESOUI</esoui> (или через Minion). Включите их в игре, затем войдите каждым персонажем хотя бы раз с активными аддонами, чтобы они могли записать данные.',
    required: 'Обязательный',
    optional: 'Необязательный',
    checking: 'Проверка…',
    notInstalledShort: 'не установлен',
    installedShort: '✓ v{{version}} установлен',
    updateAvailableShort: 'установлена v{{installed}} · доступна v{{bundled}}',
    outdatedShort: 'v{{version}} · слишком старая',
    addonInstall: 'Установить',
    addonUpdate: 'Обновить',
    addonInstalling: 'Установка…',
    addonInstallFailed: 'Не удалось установить аддон: {{message}}',
    addonNoGameFolder:
      'Папка ESO пока не найдена. Проверьте папку с данными выше или запустите игру один раз, чтобы она создала свои папки.',
    addonBundleMissing: 'В эту сборку приложения аддон не входит.',
    addonRestartNote:
      'Перезапустите ESO (или введите в игре /reloadui), чтобы аддон загрузился, затем войдите каждым персонажем один раз.',
    addonNoDataNote:
      'Установлен, но пока ничего не записал. Включите его в меню аддонов игры и войдите каждым персонажем один раз.',
    libMissingNote:
      'Data Collector не загрузится без этой библиотеки. Её нужно скачать отдельно - возьмите её на ESOUI по ссылке выше.',
    libOutdatedNote: 'Эта версия старее, чем нужна Data Collector. Обновите её на ESOUI по ссылке выше.',
    languageTitle: 'Язык',
    languageBody:
    ...
    addonsList: {
      ...
      libUndauntedPledges: {
        ...
        description:
          'Небольшая широко используемая сторонняя библиотека (не часть этого приложения), с помощью которой Data Collector вычисляет сегодняшнюю и предстоящую ротацию Неустрашимых Обетов. ESO не загрузит Data Collector, если эта библиотека не установлена.'
      }
    }
  },
