...
const ruTranslation = {
  common: {
    ...
    noCharactersFoundBody:
      'Установите и включите аддон <bold>USPF</bold> в ESO, затем зайдите хотя бы одним персонажем, чтобы он мог записывать ваш прогресс.',
    clear: 'Очистить',
    character: 'Персонаж',
  ...
  home: {
    ...
    couldntLoadHint: 'Убедитесь, что аддон USPF установлен и включён в ESO, и что вы хотя бы раз входили в игру с активным аддоном.'
  },
  ...
  musicBoxes: {
    ...
    introUntracked:
      'Все доступные сейчас предметы обстановки <bold>Шкатулка</bold>. Отмечайте, когда получите. Прогресс сохраняется на этом устройстве. Установите USPF и SkillLines и войдите персонажем, чтобы отслеживать его отдельно для каждого аккаунта и сервера.',
  ...
  settings: {
    ...
    addonsList: {
      skillLines: {
        name: 'Skill Lines',
        description:
          'Помечает каждого персонажа мегасервером, на котором он находится (NA / EU). Приложение использует это, чтобы различать ваших персонажей и обеспечивать работу переключателей Аккаунта и Сервера.'
      },
      uspf: {
        name: "Urich's Skill Point Finder (USPF)",
        description:
          'Записывает, какие задания подземелий выполнил каждый персонаж. Обеспечивает ежедневные рекомендации Неустрашимых Обетов и Список подземелий. Без него на этих страницах нет данных. Это основная функция WhatShouldIDo.'
      },
      dailyCraftStatus: {
        name: 'Daily Craft Status',
        description:
          'Отслеживает время перезарядки тренировки верховой езды и уровни Вместимости / Выносливости / Скорости каждого персонажа. Обеспечивает панель Тренировки верховой езды на странице Главная.'
      },
      dataCollector: {
        name: 'What Should I Do - Data Collector',
        description:
          'Специальный аддон-компаньон, который записывает ранг Войны Альянсов и прогресс Очков Альянса каждого персонажа (обеспечивает страницу Ранг Альянса), Очки Чемпиона каждого аккаунта по реалмам (отображается на баннере страницы Главная), а также Золото / Очки Альянса / Камни Тель-Вар / Ваучеры за поручения - как сумму, которую несёт каждый персонаж, так и общий банк аккаунта по реалмам (обеспечивает Учёт Богатства на странице Главная).'
      }
    }
  },
